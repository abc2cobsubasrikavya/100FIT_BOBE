...
#include "Rte_UserMemCpy.h"   /* for user specific memcpy */
...
#define RTE_E_COM_BUSY 		((Std_ReturnType)141u) /* [$Satisfies $SWS40 1389] */
...
#include "Rte_MemMap.h"
#else
#define Rte_memcpy(dst,src,length) Rte_UserMemCpy(dst,src,length)
#endif
