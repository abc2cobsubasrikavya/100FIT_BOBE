...
#define OS_TARGET_PATCH_VERSION (38U)

#include /* no inline */ <Os_Metrics.h>
...
/* [MISRA 2004 Rule 20.1] */ /*lint -estring(9024, CAT1_ISR) */
/* Relates to CAT1_ISR macro */
...
#else /* _lint */
  /* Only set up the intrinsic function if the GHS header has not already been included */
  #ifndef __V800_IS
    /* Pull in the compiler intrinsic functions originally from v800_ghs.h */
    /* [$TgtCore 188] [$TgtCore 189] [$TgtCore 190] [$TgtCore 191] */
    /* The intrinsic function arguments changed type between v2013.5.5 and v2014.5.5 and later versions */
    ...
    #endif
    extern void __SET1(OS_VOLATILE char *addr, __ghs_c_int__ bitnum);
    extern void __CLR1(OS_VOLATILE char *addr, __ghs_c_int__ bitnum);
...
typedef struct Os_SpinlockInfo_s {
  uint32 LockAttempts[2U]; /* [$UKS 1827] */
  uint32 LockSucceeds[2U]; /* [$UKS 1828] */
  uint32 LockFails[2U];
  Os_StopwatchTickType MaxLockTime[2U];   /* [$UKS 1829] */
  Os_LockerRefType MaxLockTimeLocker[2U]; /* [$UKS 1830] */
  Os_StopwatchTickType MaxSpinTime[2U];   /* [$UKS 1831] */
  Os_LockerRefType MaxSpinTimeLocker[2U]; /* [$UKS 1832] */
  ...
  Os_StopwatchTickType LockAttemptTime[2U]; /* [$EHI 586153] */
} Os_SpinlockInfo;
...
typedef struct Os_TaskDynType_s {
  Os_StopwatchTickType earliest_activation;
...
#define OSServiceId_Os_TimingFaultDetected ((OSServiceIdType)97)
...
#define Os_SetRestartPoint() ( (OS_NOAPPMODE == Os_CurrentAppMode) ? (Os_setjmp(Os_AnyCoreInfo[((0U == Os_CurrentAppMode) ?  ((OS_STSR(OS_HTCFG0, OS_SELID_2) >> OS_PEID_BIT1) & 1U) : Os_TgtCoreID())].RestartJumpBuf), Os_AnyCoreInfo[((0U == Os_CurrentAppMode) ?  ((OS_STSR(OS_HTCFG0, OS_SELID_2) >> OS_PEID_BIT1) & 1U) : Os_TgtCoreID())].Restartable = TRUE, E_OK) : E_OS_SYS_NO_RESTART) /* [$UKS  770] [$UKS  771] */ /*lint !e545 Address of what might be an array */
...
typedef struct Os_AnyCoreType_s {
  ...
  Os_TimeTokenType DisableAllToken;
  Os_TimeTokenType SuspendAllToken;
  Os_TimeTokenType SuspendOSToken;
  OS_VOLATILE Os_OrtiIdType OrtiApiID;
  StatusType OrtiLastError;
  Os_MetricsType Metrics;
  Os_jmp_buf RestartJumpBuf;
  boolean Restartable;
...
#define Os_DisableAllToken (os_current_core->DisableAllToken)
#define Os_SuspendAllToken (os_current_core->SuspendAllToken)
#define Os_SuspendOSToken (os_current_core->SuspendOSToken)
#define Os_OrtiApiID (os_current_core->OrtiApiID)
#define Os_OrtiLastError (os_current_core->OrtiLastError)
#define Os_Metrics (os_current_core->Metrics)
...
/* ------------------------------------------------- */
/* [MISRA 2012 Rule 20.1] */ /*lint -save -estring(9019, *) */
#define OS_START_SEC_VAR_NO_INIT_CORE0_UNSPECIFIED
#include "Std_Types.h" /* [MISRA 2012 Dir 4.10] */ /*lint !e537 !e451 */
/*lint -restore */
extern VAR(Os_ControlledCoreType, OS_VAR_NO_INIT_CORE0) Os_ControlledCoreInfo0;
extern VAR(Os_ISRDynType, OS_VAR_NO_INIT_CORE0) Os_dyn0_isrs[];
extern VAR(Os_TaskDynType, OS_VAR_NO_INIT_CORE0) Os_dyn0_tasks[];
/* [MISRA 2012 Rule 20.1] */ /*lint -save -estring(9019, *) */
#define OS_STOP_SEC_VAR_NO_INIT_CORE0_UNSPECIFIED
#include "Std_Types.h" /* [MISRA 2012 Dir 4.10] */ /*lint !e537 !e451 */
/*lint -restore */
/* ------------------------------------------------- */
/* [MISRA 2012 Rule 20.1] */ /*lint -save -estring(9019, *) */
#define OS_START_SEC_VAR_NO_INIT_CORE1_UNSPECIFIED
#include "Std_Types.h" /* [MISRA 2012 Dir 4.10] */ /*lint !e537 !e451 */
/*lint -restore */
extern VAR(Os_ControlledCoreType, OS_VAR_NO_INIT_CORE1) Os_ControlledCoreInfo1;
extern VAR(Os_ISRDynType, OS_VAR_NO_INIT_CORE1) Os_dyn1_isrs[];
extern VAR(Os_TaskDynType, OS_VAR_NO_INIT_CORE1) Os_dyn1_tasks[];
/* [MISRA 2012 Rule 20.1] */ /*lint -save -estring(9019, *) */
#define OS_STOP_SEC_VAR_NO_INIT_CORE1_UNSPECIFIED
#include "Std_Types.h" /* [MISRA 2012 Dir 4.10] */ /*lint !e537 !e451 */
/*lint -restore */
/* ------------------------------------------------- */
/* [MISRA 2012 Rule 20.1] */ /*lint -save -estring(9019, *) */
...
extern OS_VOLATILE VAR(Os_Lockable, OS_VAR_NO_INIT) Os_lock_spinlockinfo;
